class ProgrammingLanguage:
    ...
    def __init__(self, name, typing, reflection, year, pointer_arithmetic):
        ...
        typing: str, the typing type (Static/Dynamic).
        reflection: bool, whether reflection is supported.
        year: int, the year the language first appeared.
        pointer_arithmetic: bool, whether pointer arithmetic is supported.
        """
        self.name = name
        self.typing = typing
